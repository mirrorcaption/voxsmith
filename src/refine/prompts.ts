// Source of truth for refine prompts. Mirrored verbatim in
// public/refine-prompts.js so the browser can build the same system message
// when calling Cerebras directly. Keep both files in sync.
...
export const MODE_LABELS: Record<Exclude<Mode, "raw">, string> = {
  clean: "已清理",
  polish: "已润色",
...
export const STRUCTURE_EN_EXAMPLES: Example[] = [
  {
...
export const POLISH_EXAMPLES: Example[] = [
  {
...
export function buildDictionaryBlock(vocab: string[] | null | undefined): string | null {
